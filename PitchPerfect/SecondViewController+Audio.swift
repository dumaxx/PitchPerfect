...
extension SecondViewController: AVAudioPlayerDelegate {
    ...
    func playSound(rate: Float? = nil, pitch: Float? = nil, echo: Bool = false, reverb: Bool = false) {
        ...
        audioPlayerNode.scheduleFile(audioFile, at: nil) {
            ...
            self.stopTimer = Timer(timeInterval: delayInSeconds, target: self, selector: #selector(SecondViewController.stopAudio), userInfo: nil, repeats: false)
    ...
    func setPlayButtonsEnabled(_ enabled: Bool) {
        ...
        vaderPitchButton.isEnabled = enabled
